...
NAME, ARAB, ROOM, THING, VERB = (("khwab","خواب","cutting room","reel","watch")
    if KIND=="video" else ("awaz","آواز","listening room","recording","hear"))
...
<meta name=description content="Drop a %(THING)s, press one button, and get a published book: cued
chapters, checked, sealed, timestamped and minted with a DOI. Runs on your machine.">
<style>
...
<header class=hero><div class=wrap>
  ...
  <div class=specline><span>the %(ROOM)s</span><span>python 3 · standard library only</span>%(BADGE)s</div>
  <p class=lede>A %(THING)s goes in. A <em>published book</em> comes out.</p>
...
<footer><div class=wrap>
  ...
  <p style="font-size:.8rem">Where a plate or a %(THING)s in this repository names a repository, a DOI or
     ...
     not the artwork. The plates record intent; the contract records fact.</p>
                         ...
                         REPO=REPO, RAW=raw, OWN=own, SLUG=REPO.split("/")[1], BADGE=badge,
                         PORT="8711" if KIND=="video" else "8712")
